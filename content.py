...
포트폴리오는 동일가중 유니버스 평균을 <b>연 약 +5%포인트</b> 상회했습니다(2018~2024년,
7년 중 6년에서 유니버스 상회) — 특히 하락장에서 방어적인 특성을 보였습니다. 배당을 포함한
절대수익 기준으로는 시장(코스피)도 앞섰습니다. 다만 절대 수익률 자체는 높지 않았고,
특정 해(테마 랠리가 강했던 구간)에는 오히려 크게 뒤처지기도 했습니다.</p>
...
2018~2024년(7년) 백테스트했습니다. 결과: 전략 CAGR <b>+3.9%</b>로 유니버스 동일가중
(CAGR -1.9%)과 코스피(CAGR +0.4%)를 모두 앞섰고, 연평균 초과수익은 +6.0%포인트,
7년 중 5년에서 유니버스를 이겼습니다. 소형주 구간에서도 팩터 로직이 통했다는 뜻이라,
