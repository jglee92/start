...
<h2>정직한 한계</h2>
<p>과거 주식수를 완전히 확보하지 못해 시가총액은 근사치를 씁니다. 시총 3,000억 이상
중대형 종목만 대상이라 소형 가치주는 검증 범위 밖입니다. 상장폐지 종목은 마지막 체결가로
청산 처리해 실제보다 청산가치가 다소 높게 잡힐 수 있습니다. 그리고 무엇보다,
<b>과거 성과가 미래 수익을 보장하지 않습니다.</b> 이 검증은 "완전히 안전하다"는 증명이
아니라, "최소한 흔한 착시들에 속지는 않았다"는 확인입니다.</p>
