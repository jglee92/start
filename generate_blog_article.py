...
- 일반론만 나열하지 말고('분산투자하세요' 류) '실제로 어떻게 확인하는지'를 구체적으로:
  어떤 숫자를 어디서(재무제표·감사보고서·공시 어느 항목) 보고, 어떤 기준으로 판단하고,
  초보가 흔히 하는 실수는 무엇인지 단계적으로 짚어주세요. 남들 블로그에도 다 있는 뻔한
  설명보다, 직접 확인하는 실전 방법과 판단 기준이 담긴 글이 되게 하세요.

[분량] 공백 포함 2000~3000자. 짧고 뻔한 글보다 구체적 예시·판단 기준·실수 사례가 담긴
깊이 있는 글이 검색·품질 면에서 유리합니다.
